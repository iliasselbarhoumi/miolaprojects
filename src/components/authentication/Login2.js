...
//    const endpoint = "http://localhost:9090/authenticate";
    ...
    axios.post("http://localhost:9090/authenticate", user_object).then((res) => {
...
//     axios
//       .post("http://localhost:9090/authenticate", user_object)
//       .then((res) => {
...
//     axios.get("http://localhost:9090/Encadrants").then((res) => {
//       if (res.data === "success") {
//         // this.props.history.push("/dashboard");
//         History.push("/");
//       } else {
